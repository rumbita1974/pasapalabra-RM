// /data/rosco-rm.js
// Pasapalabra Database - Real Madrid Edition

export const ROSCO_DB = [
  // A - Multiple definitions (will be randomly selected)
  { 
    letter: "A", 
    answer: "Alaba", 
  ...
  { 
    letter: "B", 
    answer: "Bellingham", 
    clue: "Con la B: Jugador inglés que se cree el Beckham negro, pero acabó pareciéndose más a Gascoigne." 
  },
  ...
  { 
    letter: "C", 
    answer: "Carvajal", 
    clue: "Con la C: Capitán con rodillas calcificadas al que su entrenador odia por robarle el puesto cuando era jugador" 
  },
  { 
    letter: "C", 
    answer: "Carvajal", 
  ...
  { 
    letter: "L", 
    answer: "Lunin", 
    clue: "Con la L: El portero con cara de no haber dormido desde 2014." 
  },
  { 
    letter: "L", 
    answer: "Lunin", 
    clue: "Con la L: El suplente que solo es feliz cuando Courtois se va de vacaciones al médico." 
  },
  ...
  { 
    letter: "P", 
    answer: "Pitarch", 
    clue: "Con la P: Canterano centrocampista que no entiende que es una pared ni que choque contra ella." 
  },
  ...
  { 
    letter: "R", 
    answer: "Rüdiger", 
    clue: "Con la R: Defensa alemán al que le quitan la camisa de fuerza antes de jugar un partido de fútbol." 
  },
  { 
    letter: "R", 
    answer: "Rüdiger", 
    clue: "Con la R: Defensa alemán que un día te besa y al siguiente te parte un pierna." 
  },
  ...
  { 
    letter: "U", 
    answer: "Valverde", 
    clue: "Por la U de Uruguayo 😂: Centrocampista con tres pulmones que corre hasta para huir de Tchouaméni." 
  },
  { 
    letter: "U", 
    answer: "Valverde", 
    clue: "Por la U de Uruguayo 😂: Centrocampista que tiene un cañón en el pie y una diana en la cara para Tchouaméni." 
  },
  ...
  { 
    ...
    clue: "Con la V: Delantero piscinero y llorón que ve racismo hasta en su propia sombra." 
  },
  { 
    letter: "V", 
    answer: "Vinícius Júnior", 
    clue: "Con la V: El activista de derechos civiles que cada 3 meses mete un gol con el Madrid." 
  },
  ...
  { 
    letter: "Y", 
    answer: "Ceballos", 
    clue: "Contiene la Y (en realidad es una ll, pero se me acabaron las letras 😂): Centrocampista sevillano que lleva mas años en el Madrid que apariciones con el primer equipo." 
  },
  { 
    letter: "Y", 
    answer: "Ceballos", 
    clue: "Contiene la Y (en realidad es una ll, pero se me acabaron las letras 😂): Centrocampista sevillano al que su discusión con Arbeloa lo ratifica como titular indiscutible del banquillo." 
  },
